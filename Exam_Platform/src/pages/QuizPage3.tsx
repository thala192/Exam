    ...
    <div className="space-y-12">
      ...
      <div className="border-b border-gray-200 pb-10">
        ...
        <div className="grid gap-4">
          {['Queue', 'Stack', 'Tree', 'Graph'].map(option => (
            <label
              key={option}
            ...
            >
              <input
                ...
                onChange={() => onAnswerChange('q7', option)}
      ...
      <div className="border-b border-gray-200 pb-10">
        ...
        <div className="relative">
          <textarea
            value={answers['q8_subjective'] || ''}
            onChange={(e) => onTextAnswerChange('q8_subjective', e.target.value)}
          ...
          <div className="absolute bottom-4 right-4 text-sm text-gray-500">
            {(answers['q8_subjective'] || '').length} words
          </div>
        </div>
      </div>
      ...
      <div className="border-b border-gray-200 pb-10">
        ...
        <div className="grid gap-4">
          {['Bubble Sort', 'Quick Sort', 'Insertion Sort', 'Selection Sort'].map(option => (
            <label
              key={option}
              className={`flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all duration-200 ${
                answers['q9'] === option
            ...
            >
              <input
                ...
                onChange={() => onAnswerChange('q9', option)}
                className="w-5 h-5 text-emerald-600 focus:ring-emerald-500 border-gray-300"
              />
              <span className="ml-4 text-lg font-medium text-gray-900">
                {option}
