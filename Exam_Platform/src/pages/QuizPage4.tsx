    ...
    <div className="space-y-12">
      ...
      <div className="border-b border-gray-200 pb-10">
        ...
        <div className="grid gap-4">
          {['MongoDB', 'PostgreSQL', 'Cassandra', 'Redis'].map(option => (
            <label
              key={option}
            ...
            >
              <input
                ...
                onChange={() => onAnswerChange('q10', option)}
      ...
      <div className="border-b border-gray-200 pb-10">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-4">
          Explain the concept of RESTful APIs and list the main HTTP methods used in REST.
        </h2>
        ...
        <div className="relative">
          <textarea
            value={answers['q11_subjective'] || ''}
            onChange={(e) => onTextAnswerChange('q11_subjective', e.target.value)}
          ...
          <div className="absolute bottom-4 right-4 text-sm text-gray-500">
            {(answers['q11_subjective'] || '').length} words
          </div>
        </div>
      </div>
      ...
      <div className="border-b border-gray-200 pb-10">
        ...
        <div className="grid gap-4">
          {['Django', 'Express.js', 'React', 'Flask'].map(option => (
            <label
              key={option}
              className={`flex items-center p-4 border-2 rounded-xl cursor-pointer transition-all duration-200 ${
                answers['q12'] === option
            ...
            >
              <input
                ...
                onChange={() => onAnswerChange('q12', option)}
                className="w-5 h-5 text-emerald-600 focus:ring-emerald-500 border-gray-300"
              />
              <span className="ml-4 text-lg font-medium text-gray-900">
                {option}
