...
const QuizPage2: React.FC<QuizPage2Props> = ({
  onAnswerChange,
  onTextAnswerChange,
  answers
}) => {
    ...
    <div className="space-y-12">
      ...
      <div className="border-b border-gray-200 pb-10">
        ...
        <div className="grid gap-4">
          {['Python', 'Java', 'HTML', 'Ruby'].map(option => (
            <label
              key={option}
            ...
            >
              <input
                ...
                onChange={() => onAnswerChange('q4', option)}
      ...
      <div className="border-b border-gray-200 pb-10">
        ...
        <div className="relative">
          <textarea
            value={answers['q5_subjective'] || ''}
            onChange={(e) => onTextAnswerChange('q5_subjective', e.target.value)}
          ...
          <div className="absolute bottom-4 right-4 text-sm text-gray-500">
            {(answers['q5_subjective'] || '').length} words
          </div>
        </div>
      </div>
          ...
          {['O(1)', 'O(log n)', 'O(n)', 'O(n²)'].map(option => (
            ...
            >
              <input
                ...
                onChange={() => onAnswerChange('q6', option)}
                className="w-5 h-5 text-emerald-600 focus:ring-emerald-500 border-gray-300"
              />
              <span className="ml-4 text-lg font-medium text-gray-900">
                {option}
